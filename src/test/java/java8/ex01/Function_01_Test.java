...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = (Integer i) -> new Person("first_" + i, "last_" + i, i, "pass_" + i);
    // end::intToPerson[]
    ...
    private Function<Integer, Account> intToAccountWithCompose = (Integer i) -> personToAccount.apply(intToPerson.apply(i));
    ...
    private Function<Integer, Account> intToAccountWithAndThen = (Integer i) -> intToPerson.andThen(personToAccount).apply(i);
    // end::intToAccountWithAndThen[]
    //personToAccount.andThen(intToPerson.apply(i))
